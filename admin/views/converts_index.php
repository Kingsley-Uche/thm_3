...
<!-- Bordered table end -->
	...
	<div class="col-12 mt-3">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title">Converts list</h4>
   ...
   if(isset($_SESSION['update'])){
     ...
     unset($_SESSION['update']);
				...
				<div class="card-body">
                <button class='btn btn-primary call_modal pull-left' value='Add a Converts' type='button' name='add_convert'><i class='la la-plus' style="font-size:14px"> Add to Converts</i></button></p>
				</div>
                    ...
                    <thead class="thead-light">
						...
						$count=0;
 						foreach($_SESSION['members'] as $memb){
                            ...
                            echo "</td>";
							echo "<form action='../router/contact.php' method='post' name='alter_converts'>";
                            echo "<input type='hidden' name='contact' value='edit/delete/converts'>";
							echo "<td>";
							...
							echo "<button class='btn btn-flat btn-info' class='edit'  name='convert_edit' ". "value=".$memb['id']."><i class='la la-pencil'></i></button>";
