...
<!-- Bordered table end -->
   ...
   if(isset($_SESSION['update'])){
     ...
     unset($_SESSION['update']);
				...
				<?php if(isset($_SESSION['prayer_req'])&& $_SESSION['prayer_req']!=''){
					$items= $_SESSION['prayer_req'];
					...
					<table class="table table-striped">
						...
						<?php
 						...
 						foreach($items as $event){
 							...
 							echo "<td>";
 							echo $event['name_prayer'];
 							echo "</td>";
								
 							echo "<td>";

 						 echo $event['email_prayer'];
 							echo "</td>";
							 echo "<td>";

 						 echo $event['phone_prayer'];
 							echo "</td>";
							echo "<td>";

 						 echo $event['prayer_content'];
 							echo "</td>";
						
                             echo "<td>";

 						 echo $event['time_sent_in'];
 							echo "</td>";
