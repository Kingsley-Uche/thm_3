...
<!-- Bordered table end -->
   ...
   if(isset($_SESSION['update'])){
     ...
     unset($_SESSION['update']);
            ...
            <h3 class="content-header-title">Edit Ministry Videos</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Edit Ministry Videos
                  </li>
                </ol>
              </div>
            </div>
...
<input type='hidden' name="ministry_update">
<?php
foreach($videos as $vid){

?>
<input type='hidden' name="ministry_id" value="<?php echo $vid['id'];?>">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 ">
          <div class="card">
              ...
              <div class="card-block">
                  <div class="card-body">
                      <fieldset class="form-group">
                        <i class='la la-video-camera primary'></i><input type="text" class="form-control danger rounded" value="" id="name_testifier" name="video_url" placeholder="Enter your video embed url"  required>
                      </fieldset>
              ...
              <div class="card-block">
                  <div class="card-body">
                      <fieldset class="form-group">
                          <input type="text" name='title_video' class="form-control" id="title_testimony" placeholder="Title"  value="<?php echo $vid['title'];?>" required>
                      </fieldset>
              ...
              <div class="form-group">
                  <div class="card-body">
                      ...
                      <fieldset class="form-group">
                    <textarea id="txtEditor" name='content' class='form-control jqte-test' style='height:100px'  required> <?php echo $vid['description'];?></textarea> 
                      </fieldset>
